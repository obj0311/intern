...
int main(int argc, char* argv[]) {
    ...
    //std::string file_path = "D:/obj_data/portraitVue-Enhancement-code/s2.pt";
    //std::string input_img_path = "D:/obj_data/portraitVue-Enhancement-code/input.png";
    ...
    if (!std::filesystem::exists(model_loc)) {
        std::cerr << "모델이 존재하지 않습니다: " << model_loc << std::endl;
        return 1;
    }
