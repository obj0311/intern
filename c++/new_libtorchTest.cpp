// new_libtorchTest.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
int main() {
	...
	const string weight_path = "D:/obj_data/vscode/traced_resnet18.pt";
	const string label_path = "D:/label.txt";
	const string img_path = "D:/dog.jpg";
